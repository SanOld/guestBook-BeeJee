...
<html lang="en">
	...
	<body>
        ...
        <div class="container">
            <div class="row">
                <input type="button" class="form-control" id="back"  value="На главную" >
                <hr>
                <hr>
                <hr>
                <form id="loginform" class="form-horizontal" method="get" action="<?php echo  BASE_URL ;?>">
                    <input type="text" class="form-control"  name="cr" value="editor" style="display: none">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="password" class="form-control"  name="fields[]" value="password" style="display: none">
                      <input type="text" class="form-control"  name="values[]" value="">
                    </div>
                  </div> 
                  <div class="form-group">
                    <div class="col-sm-offset-2 col-sm-10">
                      <button type="button" id="sbt" class="btn btn-default">Отправить</button>
                    </div>
                  </div>
